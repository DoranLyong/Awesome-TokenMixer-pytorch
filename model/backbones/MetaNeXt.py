# (ref) https://github.com/sail-sg/inceptionnext

"""
MetaNeXt baselines with InceptionNeXt.
Some implementations are modified from timm (https://github.com/huggingface/pytorch-image-models).
"""

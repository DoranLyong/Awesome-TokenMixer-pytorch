...
class GraphLU(nn.Module):
    def __init__(self, eps=1.0):        
        ...
        self.eps = nn.Parameter(torch.tensor([eps]), requires_grad=True)  # 가중치를 학습 가능한 매개변수로 설정
